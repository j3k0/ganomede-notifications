...
For now, only aliases are expanded from `userId`s via [ganomede-directory](https://github.com/j3k0/ganomede-directory). See [`translator.ts`](/src/push-api/translator.ts) for details.
